<template>
    <div>
        ...
        <div>
            <p>x-streaming {{$t('slogan')}}</p>
            <div style="margin-bottom:10px">{{$t('slogan2')}}</div>
            <Button type="success" to="http://docs.arch.run" target="_blank">🚀START</Button>
            <span style="margin: 0 10px"></span>
            <Button type="default" target="_blank" to="https://github.com/crazybber">
